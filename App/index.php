...
<html lang="en">
    ...
    <body>
		...
		<?php include 'Composants/slider.php';?>
											...
											<div class="card" id="Compositeur Collectif">
												...
												<div class="card card-body">
													<p class="card-text mt-2">
														...
														Lieu : rue de l’église + place de l’église + rue de la ferme dans sa totalité, fin à la rue du potager (cf. zone orange sur le plan ci-dessous) <br> <br>
												...
												<div>
													<img src="../assets/img/plan du site.jpg" alt="" style="height: 90%; width: 100%;">
												</div>

												
													<div class="Rejoindre mt-5" style="margin-left:200px">
														<a href="https://lameup.mystrikingly.com/" class="rejoindre-link">Réservez ici</a>
													</div>
